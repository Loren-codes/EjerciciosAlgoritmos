...
void registrarEstudiante(vector<Estudiante>& estudiantes) {
    ofstream archivo("registro_estudiantes.txt", ios::app); // Abrimos archivo en modo append
        ...
        if (opcionCarrera >= 1 && opcionCarrera <= 6) {
            switch (opcionCarrera) {
                case 1:
                    ...
                    break;
                case 2:
                    nuevoEstudiante.carrera = "Administración";
                    break;
                case 3:
    ...
    archivo << "====================================================================\n";
    archivo << "Fecha de registro: " << obtenerFechaActual() << "\n";
    archivo << "--------------------------------------------------------------------\n";
    archivo << "Código: " << nuevoEstudiante.codigoEstudiante << "\n";
    archivo << "Nombres: " << nuevoEstudiante.nombres << "\n";
    archivo << "Apellidos: " << nuevoEstudiante.apellidos << "\n";
    archivo << "Departamento: " << nuevoEstudiante.departamento << "\n";
    archivo << "Municipio: " << nuevoEstudiante.municipio << "\n";
    archivo << "Carrera: " << nuevoEstudiante.carrera << "\n";
    archivo << "Fecha de Nacimiento: " << nuevoEstudiante.fechaNacimiento << "\n";
    archivo << "Edad: " << nuevoEstudiante.edad << "\n";
    archivo << "Años en la Universidad: " << nuevoEstudiante.aniosEnUniversidad << "\n";
    archivo << "Semestre: " << nuevoEstudiante.semestre << "\n";
    archivo << "====================================================================\n";
    archivo.flush(); // Aseguramos que se escriba inmediatamente
    ...
    archivo.close(); // Cerramos el archivo antes de salir o continuar
...
string obtenerFechaActual() {
    ...
    string dia = to_string(ltm->tm_mday);
    string mes = to_string(1 + ltm->tm_mon);
    string anio = to_string(1900 + ltm->tm_year);
